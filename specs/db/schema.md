...
> Complete reference for localStorage data structures

## Key Conventions

### Prefix

All keys use `memory_match_` prefix to avoid conflicts with other applications.
...
1. Increment `version` number in export format
...
- [Storage Operations](./storage-spec.md)
- [Classic Matching Mode](../product/classic-matching.md)
- [N-back Training](../product/nback-training.md)
