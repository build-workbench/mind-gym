(function (root, factory) {
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = factory(require('./keys.js'), require('./stats.js'), require('./achievements.js'), require('./import-export.js'));
  } else {
    root.RememberStorage = factory(root.RememberKeys, root.RememberStats, root.RememberAchievements, root.RememberImportExport);
  }
})(typeof self !== 'undefined' ? self : this, function (RememberKeys, RememberStats, RememberAchievements, RememberImportExport) {
  ...
  function loadSettings(fallbackSettings) {
    return normalizeSettings(safeParseJSON(RememberKeys.settingsKey(), cloneSettings(fallbackSettings)), fallbackSettings);
  }
