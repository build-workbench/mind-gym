...
- [Jaeggi et al. (2008), _Improving fluid intelligence with training on working memory_](https://doi.org/10.1073/pnas.0801268105) : classic dual n-back reference.
- [Klingberg (2010), _Training and plasticity of working memory_](https://doi.org/10.1016/j.tics.2009.06.004) : working-memory training overview.
